...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin_assets/css/auth.css')}}">
    <script src="{{asset('admin_assets/js/jquery-3.7.0.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('admin_assets/plugins/bootstrap/js/bootstrap.bundle.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('admin_assets/plugins/Iconsax/geticons.js')}}" type="text/javascript"></script>
    <script src="{{asset('admin_assets/js/function.js')}}" type="text/javascript"></script>
