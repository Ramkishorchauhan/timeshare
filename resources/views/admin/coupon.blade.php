...
<div class="body-main-content">
    <div class="timeshare-section">
        <div class="timeshare-header">
            <div class="mr-auto">
                <h4 class="heading-title">Manage Referral Code</h4>
            </div>
            <div class="ts-filter wd30">
                <div class="row g-2">
                    <div class="col-md-12">
                        <div class="form-group">
                        <a class="Create-btn" data-bs-toggle="modal" data-bs-target="#Createreferral">Create New Referral</a>
                        </div>
                    </div>
                </div>    
            </div>
 ...
 <!-- Create Referral -->
 <div class="modal lm-modal fade" id="Createreferral" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="timeshare-modal-form">
            ...
            @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <input name="couponname" type="text" class="form-control" placeholder="Referral Name (EX. TIMESHARE20)" required>
                        </div>
                    </div>
