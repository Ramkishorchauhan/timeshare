            ...
            <div class="sidebar-nav">
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                        ...
                        <li class="nav-item @if($route_name=='admin.referral-code') active @endif">
                            <a class="nav-link" href="{{route('admin.referral-code')}}">
                                ...
                                <span class="menu-title">Manage Referral Code</span>
                            </a>
                        </li>
