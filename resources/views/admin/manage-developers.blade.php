                ...
                <div class="col-md-4">
                    <div class="manage-developers-item">
                        ...
                        <div class="manage-developers-action">
                            <button type="button" value="{{$developer['id']}}" class="edit-btn"> 
					 			Edit Details
                            </button>
							...
							<a href="{{ url('admin/developer-details') }}/{{ $developer['id'] }}"  class="view-btn">View Details</a>							
                        </div>
                    </div>
                </div>
                @endforeach                
      ...
      <div class="modal-body">
        <div class="timeshare-modal-form">
            ...
            <div class="row">              
				...
				<div class="col-md-6">
                    <div class="form-group">
                        <input type="number" class="form-control @error('valid_days') is-invalid @enderror" placeholder="contract valid days limit " name="valid_days" required>
                    </div>
                </div>
      ...
      <div class="modal-body">
        <div class="timeshare-modal-form">
            ...
            <div class="row">
				...
				<div class="col-md-6">
                    <div class="form-group">
                        <input type="number" class="form-control" name="valid_days" id="valid_days">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <button  class="save-btn">Update Developer</button>
                    </div>
                </div>
            </div>
         </form>
    ...
    $(document).on('click','.edit-btn',function() {
        ...
        $.ajax({
			...
			success : function(res){
                ...
                $('#valid_days').val(res.developers.valid_days);
